...
public class buttons : MonoBehaviour
{
    ...
    public void Lvl1()
    {
        ...
        Score.transform.Find("score").transform.GetComponentInChildren<TextMeshProUGUI>().text = "Счет: " + PlayerPrefs.GetInt("lvl1Score").ToString();
    ...
    public void Lvl2()
    {
        ...
        Score.transform.Find("score").transform.GetComponentInChildren<TextMeshProUGUI>().text = "Счет: " + PlayerPrefs.GetInt("lvl2Score").ToString();
        Score.transform.Find("mark").transform.GetComponentInChildren<TextMeshProUGUI>().text = "Оценка: " + PlayerPrefs.GetString("lvl2Mark");
    }
    public void Lvl3()
    {
        Time.timeScale = 1;
        ...
        Score.transform.Find("score").transform.GetComponentInChildren<TextMeshProUGUI>().text = "Счет: " + PlayerPrefs.GetInt("lvl3Score").ToString();
        Score.transform.Find("mark").transform.GetComponentInChildren<TextMeshProUGUI>().text = "Оценка: " + PlayerPrefs.GetString("lvl3Mark");
    }
